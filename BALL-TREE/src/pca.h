...
public:
	...
	//Cálculo del PCA en la matriz de entrada
	...
	//Reproyeccion de ,os datos utilizando la matriz de proyeccion, los valores y vectores propios
...
private:
	...
	Eigen::Matrix<Type, Eigen::Dynamic, Eigen::Dynamic> project_data(const Eigen::Matrix<Type, Eigen::Dynamic, Eigen::Dynamic>& data_matrix, int num_components)
        {
        	const Eigen::Matrix<Type, Eigen::Dynamic, Eigen::Dynamic>& W = eigen_vectors.adjoint();
        	const Eigen::Matrix<Type, Eigen::Dynamic, Eigen::Dynamic>& projected_data_matrix = W.topRows(num_components) * data_matrix.adjoint();
        	return projected_data_matrix.transpose();
        }
